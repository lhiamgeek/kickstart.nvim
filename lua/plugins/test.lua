...
return {
  {
    ...
    keys = {
      ...
      { prefix .. 'f', function() require('neotest').run.run(vim.fn.expand '%') end, desc = 'Run all tests in file'},
      { prefix .. 'p', function() require('neotest').run.run(vim.fn.getcwd()) end, desc = 'Run all tests in project'},
