  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map('gr', '<cmd>Lspsaga finder ref<cr>', '[G]oto [R]eferences')
        ...
        map('<leader>cs', '<cmd>Lspsaga outline<cr>', '[C]ode [S]ymbols')
        ...
        -- callhierarchy
        map('<leader>ci', '<cmd>Lspsaga incoming_calls<cr>', '[C]all [I]ncoming_calls')
        map('<leader>co', '<cmd>Lspsaga outcoming_calls<cr>', '[C]all [O]utcoming_calls')
    ...
    -- add server which has standalone config to this list
